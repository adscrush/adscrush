...
interface ClickLogsToolbarProps {
  /**
  ...
  /** Filename prefix for the downloaded CSV (e.g. "click-logs"). */
  filename?: string
}

export function ClickLogsToolbar({ onExport, filename = "click-logs" }: ClickLogsToolbarProps) {
  // Hooks must be called unconditionally at the top of the component.
  const [filters, setFilters] = useQueryStates(clickLogsSearchParams, {
    shallow: false,
  })
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      toast.error("Failed to export click logs. Please try again.")
    } finally {
