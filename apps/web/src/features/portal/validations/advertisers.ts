...
export const portalAdvertiserSearchParamsCache = createSearchParamsCache({
...
export type GetPortalAdvertisersSchema = Awaited<
  ReturnType<typeof portalAdvertiserSearchParamsCache.parse>
>
